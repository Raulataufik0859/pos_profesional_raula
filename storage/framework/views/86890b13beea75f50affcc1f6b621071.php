...
<?php $__env->startSection('content'); ?>
    ...
    <div
        class="relative min-h-screen flex items-center justify-center px-4 py-12 overflow-hidden select-none
        ...
        <div
            class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-fuchsia-600/30 rounded-full glow-orb pointer-events-none">
        </div>
        ...
        <div class="relative w-full max-w-md perspective-1000">
            ...
            <div class="text-center mb-8 float-anim">
                <div
                    class="inline-flex items-center justify-center w-24 h-24 rounded-[28px]
            ...
            <div
                class="login-card-3d preserve-3d bg-white/10 backdrop-blur-2xl rounded-3xl border border-white/20 p-8 sm:p-10">
