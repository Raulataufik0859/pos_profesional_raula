        ...
        <div class="flex items-center gap-3 w-full">
            ...
            <div class="sidebar-text flex-1 min-w-0">
                ...
                <p class="text-xs text-green-600 dark:text-green-400 flex items-center gap-1">
                    ...
                    <?php echo e(ucfirst($roleName)); ?> · Online
                </p>
            </div>
            ...
            <div>
                ...
                <button type="button" id="report-toggle"
                    ...
                    <svg id="report-chevron"
                        class="sidebar-text w-4 h-4 transition-transform duration-200 <?php echo e(request()->is('laporan*') ? 'rotate-180' : ''); ?>"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div id="report-submenu"
                    class="ml-3 mt-0.5 space-y-0.5 border-l-2 border-indigo-100 dark:border-indigo-900/50 pl-2 <?php echo e(request()->is('laporan*') ? '' : 'hidden'); ?>">
                    ...
                    <?php echo e(request()->is('laporan') && !request()->is('laporan/*') ? 'bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 font-medium' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800'); ?>">
                        <span class="w-1.5 h-1.5 rounded-full bg-current opacity-60"></span>
                        <span class="sidebar-text">Ringkasan</span>
                    </a>
                    <a href="<?php echo e(route('laporan.penjualan')); ?>"
                        class="sidebar-item flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm transition
                    <?php echo e(request()->is('laporan/penjualan*') ? 'bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 font-medium' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800'); ?>">
                        <span class="w-1.5 h-1.5 rounded-full bg-current opacity-60"></span>
                        <span class="sidebar-text">Penjualan</span>
                    </a>
                    <a href="<?php echo e(route('laporan.pembelian')); ?>"
                        class="sidebar-item flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm transition
                    <?php echo e(request()->is('laporan/pembelian*') ? 'bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 font-medium' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800'); ?>">
                        <span class="w-1.5 h-1.5 rounded-full bg-current opacity-60"></span>
                        <span class="sidebar-text">Pembelian</span>
                    </a>
                    <a href="<?php echo e(route('laporan.stok')); ?>"
                        class="sidebar-item flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm transition
                    <?php echo e(request()->is('laporan/stok*') ? 'bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 font-medium' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800'); ?>">
                        <span class="w-1.5 h-1.5 rounded-full bg-current opacity-60"></span>
