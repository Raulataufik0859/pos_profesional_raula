                    ...
                    <div class="relative">
                        ...
                        <div id="notif-dropdown"
                            ...
                            <div
                                ...
                                <span
                                    class="text-xs text-indigo-600 dark:text-indigo-400 font-medium"><?php echo e($notifCount); ?>
                                    ...
                                    <a href="<?php echo e(url('/produk')); ?>"
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                                                <?php echo e($p->nama); ?> stok sudah 0</p>
                                        </div>
                                    </a>
                                ...
                                <?php $__currentLoopData = $notifStokRendah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(url('/produk')); ?>"
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                                                <?php echo e($p->nama); ?> tersisa <?php echo e($p->stok); ?> pcs</p>
                                        </div>
                                    </a>
