                                    ...
                                    <?php $__currentLoopData = $sale->itemPenjualan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex justify-between text-xs gap-2">
                                            <span class="text-gray-700 dark:text-gray-300 truncate">
                                                <?php echo e($item->produk?->nama ?? '-'); ?> <span
                                                    class="text-gray-400">×<?php echo e($item->kuantitas); ?></span>
                                            </span>
                                ...
                                <div class="p-4 pb-5 text-center">
                                    <div class="inline-block bg-white p-2 rounded-xl cursor-pointer"
                                        ...
                                        <img src="<?php echo e(asset('imageqris/qris-allpay.jpg')); ?>" alt="QRIS"
                                            ...
                                            onerror="this.src='<?php echo e(asset('imageqris/qris')); ?>'">
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="flex justify-between text-sm mb-2">
                                        ...
                                        <span class="font-medium text-gray-900 dark:text-white">Rp
                                            <?php echo e(number_format($sale->total_pembayaran, 0, ',', '.')); ?></span>
                                    </div>
