                    ...
                    <div class="relative">
                        ...
                        <div id="notif-dropdown"
                            ...
                            <div
                                ...
                                <span class="text-xs text-indigo-600 dark:text-indigo-400 font-medium">{{ $notifCount }} item</span>
                            </div>
                            <div class="max-h-80 overflow-y-auto">
                                ...
                                <a href="{{ url('/produk') }}"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{{ $p->nama }} stok sudah 0</p>
                                    </div>
                                </a>
                                @empty
                                @endforelse
                                ...
                                <a href="{{ url('/produk') }}"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{{ $p->nama }} tersisa {{ $p->stok }} pcs</p>
                                    </div>
                                </a>
                                @endforeach
